...
namespace Abstraction
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //abstractApple = (AbstractApple)goldenApple;
            ...
            {
                case 1:
                    abstractApple = goldenApple; 
                    break;
                case 2:
                    abstractApple = new DemirApple("demir", "green");
                    break;
                case 3:
                    abstractApple = norTarvaSexaniApple;
                    break;
                default: break;
            ...
            GoldenApple goldenApple2 =  abstractApple as GoldenApple;
            Console.ReadKey();
        }
    }
}
